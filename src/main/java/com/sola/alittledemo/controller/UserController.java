...
public class UserController {
    ...
    public Object testAsync() {
        ...
        // userService.testAsync(new BookReq(1L, "book1"), "sususu", 100);
        // userService.testAsync(new BookReq(1L, "book1"), "", 100);
        // userService.testAsync(new BookReq(1L, "book1"), null, 100);
